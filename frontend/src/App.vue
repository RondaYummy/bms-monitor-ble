...
console.info('%c                    ', 'background: #0057B8; font-size: 18px;');
console.info('%c                    ', 'background: #FFD700;  font-size: 18px;');
console.groupEnd();
...
if (/iPad|iPhone|iPod/.test(navigator.userAgent)) {
  ...
  window.addEventListener('touchmove', handler as EventListenerOrEventListenerObject, {
    passive: false,
  });
