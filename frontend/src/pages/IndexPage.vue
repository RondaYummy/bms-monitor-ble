...
const topTapoDevices = [
  {
    id: 1,
    ip: "192.168.1.10",
    email: "user1@example.com",
    device_on: 1,
    device_id: "TAPO123456",
    power_watt: 52.4,
    priority: 1,
    name: "Обігрівач у вітальні",
    model: "Tapo P110",
    fw_ver: "1.3.2",
    hw_ver: "2.0",
    added_at: "2025-10-20T12:34:56Z",
    timer: true,
    timerTimeLeft: 120,
  },
  {
    ...
    device_on: 0,
    device_id: "TAPO654321",
    power_watt: 0,
    priority: 2,
    name: "Лампа біля ліжка",
    model: "Tapo P100",
    fw_ver: "1.1.0",
    hw_ver: "1.0",
    added_at: "2025-09-30T09:15:00Z",
    timer: true,
    timerTimeLeft: 120,
  },
  {
  ...
  },
  {
    ...
    device_on: 1,
    device_id: "TAPO112233",
    power_watt: 7.8,
    priority: 4,
    name: "Нічник у дитячій",
    model: "Tapo P105",
    fw_ver: "1.0.6",
    hw_ver: "1.1",
    added_at: "2025-10-10T21:10:45Z",
    timer: true,
    timerTimeLeft: 120,
  },
  {
    ...
    device_on: 0,
    device_id: "TAPO778899",
    power_watt: 0,
    priority: 5,
    name: "Кавоварка на кухні",
    model: "Tapo P115",
    fw_ver: "1.2.1",
    hw_ver: "2.0",
    added_at: "2025-07-01T08:00:00Z",
    timer: true,
    timerTimeLeft: 120,
  },
];
