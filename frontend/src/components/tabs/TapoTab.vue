<template>
  ...
  <div class="red-item">
    <q-expansion-item :disable="!token" v-model="expandAddTapoDevice" icon="add" label="Add new device" dark
      ...
      <q-input label-color="white" label="Email from Tapo App" :disable="!token" v-model="newTapoDevice.email" filled
        class="q-mb-sm q-mt-sm" style="flex: 1 1 auto" />
      <q-input label-color="white" label="Password from Tapo App" :disable="!token" v-model="newTapoDevice.password"
        ...
        <q-card dark style="min-width: 350px">
          ...
          <q-card-section class="q-pt-none">
            <div class="row justify-between items-center">
              <q-input label-color="white" label="Device IP Address" :disable="!token" v-model="newTapoDevice.ip" filled
                class="q-mb-sm q-mt-sm" style="flex: 1 1 auto" />
          ...
          <q-card-actions align="right" class="text-primary">
            ...
            <q-btn v-close-popup :loading="loadingDevices" @click="addTapoDevice" :disable="!token || !newTapoDevice.ip || !newTapoDevice.email || !newTapoDevice.password
